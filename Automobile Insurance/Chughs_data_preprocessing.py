...
processed_data.to_csv(r"/Users/abhiishekchugh/Documents/GitHub/CANN-for-Fraud-Detection/Automobile Insurance/data/Pre-Processed_Chugh.csv", index=False)
...
data['FraudFound'] = yLabel
data=data.rename({'daysDiff':'DaysDiff'},axis=1)
data.to_csv(r"/Users/abhiishekchugh/Documents/GitHub/CANN-for-Fraud-Detection/Automobile Insurance/data/Pre-Processed-Encoded_Chugh_LOOE_FOR_ALL.csv",index=False)
...
data['FraudFound'] = yLabel
data=data.rename({'daysDiff':'DaysDiff'},axis=1)
data.to_csv(r"/Users/abhiishekchugh/Documents/GitHub/CANN-for-Fraud-Detection/Automobile Insurance/data/Pre-Processed-Encoded_Chugh_CBE_FOR_ALL.csv",index=False)
...
data['FraudFound'] = yLabel
data=data.rename({'daysDiff':'DaysDiff'},axis=1)
data.to_csv(r"/Users/abhiishekchugh/Documents/GitHub/CANN-for-Fraud-Detection/Automobile Insurance/data/Pre-Processed-Encoded_Chugh_WOE_FOR_ALL.csv",index=False)


###############################################
# Here onwards we will perform different types of encoding
###############################################

data = processed_data

#For the VehiclePrice and Days:Policy-Accident, AddressChange-Claim column we use Backward Difference Encoding
for i in ['VehiclePrice','Days:Policy-Accident','AddressChange-Claim','NumberOfCars', 'PastNumberOfClaims','BasePolicy','Sex','MaritalStatus','VehicleCategory','Fault','AgentType','AccidentArea','NumberOfSuppliments','Days:Policy-Claim']:
...
data.to_csv(r"/Users/abhiishekchugh/Documents/GitHub/CANN-for-Fraud-Detection/Automobile Insurance/data/Pre-Processed-Encoded_Chugh.csv",index=False)
